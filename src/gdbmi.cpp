...
gdbmi::StringView
gdbmi::Tokenizer::next_token(eToken * type)
{
	*type = T_EOF;
	StringView curbuf;
...
gdbmi::StringView
gdbmi::Tokenizer::read_string(eToken * type)
{
...
gdbmi::StringView
gdbmi::Tokenizer::read_word(eToken * type)
{
	size_t start_pos = m_pos;
...
void
gdbmi::Parser::parse_properties(Tokenizer * tokenizer, Node::ptr_t parent)
{
	gdbmi::eToken token;
